...
class Controller(tk.Tk):
    ...
    def __init__(self):
        ...
        # self.reconnect_btn = tk.Button(self, text='Reconnect', bd=1, relief=tk.SUNKEN, anchor=tk.SE)    
        # self.reconnect_btn.pack(side=tk.BOTTOM)
...
class LoginPage(tk.Frame):
    ...
    Enter below your username and password.
        ...
        # Bottom status bar
        #self.statusinfo = tk.StringVar()
        #self.server_address = ('123', 123)
        #self.connection_status = 'test'
        #self.statsbar = tk.Label(self, textvariable=self.statusinfo, bd=1, relief=tk.SUNKEN, anchor=tk.W)
        #self.statsbar.pack(side=tk.BOTTOM, fill=tk.X)
