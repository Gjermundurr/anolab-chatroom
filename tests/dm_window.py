...
left_frame = tk.Frame(user_frame).pack(side='left')
right_frame = tk.Frame(user_frame).pack(side='right', fill='y')
user_scroll = tk.Scrollbar(right_frame).pack(side='right', fill='y')
user1 = tk.Label(left_frame, text='test', highlightcolor='red', bd=4).pack()
user2 = tk.Label(left_frame, text='test', highlightcolor='red').pack()
user3 = tk.Label(left_frame, text='test', highlightcolor='red').pack()
user4 = tk.Label(left_frame, text='test', highlightcolor='red').pack()
user5 = tk.Label(left_frame, text='test', highlightcolor='red').pack()
