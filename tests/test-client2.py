...
class LoginWindow(tk.Frame):
    ...
    def __init__(self, master):
        ...
        # lambda: master.switch_frame(MainWindow)
...
class MainWindow(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.display_chat = tk.Text(self.first_frame, height=15, width=55, state='disabled')
        ...
        self.msg_button = tk.Button(self.second_frame, text='Enter', command=self.get_message)
    ...
    #     while True:
    #         data = client_sock.handle_recv().decode('utf-8')
    #         self.display_chat.config(state='normal')
    #         self.display_chat.insert('end', data + '\n')
    #         self.display_chat.config(state='disabled')
